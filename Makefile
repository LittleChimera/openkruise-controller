...
KIND_CLUSTER ?= openkruise-controller-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name openkruise-controller-builder
	$(CONTAINER_TOOL) buildx use openkruise-controller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm openkruise-controller-builder
	rm Dockerfile.cross
